...
import filterByNavigationCategory from './navigation.util.filter-by-navigation-category';
import filterByNavigationComponent from './navigation.util.filter-by-navigation-component';
import filterByNavigationExternalLink from './navigation.util.filter-by-navigation-external-link';
import mapComponentToElement from './navigation.util.map-component-to-element';
import mapTranslateFunctionToNavigationTextTranslator from './navigation.util.map-translate-function-to-navigation-text-translator';
