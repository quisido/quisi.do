    ...
    <Page>
      <Main>
        <Region heading={<I18n>Privacy policy</I18n>}>
          ...
          <Paragraph>
            In order to support you, your services, and quisi.do&apos;s
            services, quisi.do may send your personal data to third parties,
            such as Cloudflare, Datadog, or Sentry.
          </Paragraph>
        </Region>
      </Main>
    </Page>
