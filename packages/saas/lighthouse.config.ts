...
const CONFIG: Config = {
  ...
  settings: {
    ...
    skipAudits: [
       ...
       * {@link https://www.w3.org/TR/wai-aria-1.3/#sectionhead | 2024 WAI ARIA 1.3 Public Working Draft},
       * which does not include all of the roles in the
       * {@link https://w3c.github.io/aria/#sectionhead | 2026 WAI ARIA 1.3 Editor's Draft}.
       */
      'aria-roles',
    ],
  },
