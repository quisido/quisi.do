...
export default function mapAuthnErrorCodeToContent(
  ...
  switch (code) {
    ...
    case ErrorCode.MissingIsolateEnvironment:
      return [
        <I18n>Missing isolate environment</I18n>,
        <>
    ...
    case ErrorCode.MissingPatreonOAuthClientSecret:
      return [
        <I18n>Missing client secret</I18n>,
        <>
          <I18n>The Patreon client could not be found.</I18n>
          <I18n>The developer has been notified. Please try again later.</I18n>
        </>,
    ...
    case ErrorCode.InvalidPatreonOAuthHost:
      return [
        <I18n>Invalid host</I18n>,
        <I18n>The Patreon host could not be identified.</I18n>,
      ];
    ...
    case ErrorCode.MissingPatreonIdentityId:
      return [<I18n>Missing ID</I18n>, <I18n>An unknown error occurred.</I18n>];
