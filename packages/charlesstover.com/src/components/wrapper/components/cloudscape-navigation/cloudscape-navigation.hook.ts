...
import filterCloudscapeSideNavigationItemsByExpandable from '../../utils/filter-cloudscape-side-navigation-items-by-expandable';
import filterCloudscapeSideNavigationItemsByHasItems from '../../utils/filter-cloudscape-side-navigation-items-by-has-items';
import mapTranslationFunctionToCloudscapeSideNavigationItems from '../../utils/map-translation-function-to-cloudscape-side-navigation-items';
...
const mapIndexPrefixToItemToExpandedMapper = (
  ...
  return function mapItemToExpanded(
    ...
    if (filterCloudscapeSideNavigationItemsByExpandable(newItem)) {
    ...
    if (filterCloudscapeSideNavigationItemsByHasItems(newItem)) {
...
export default function useCloudscapeWrapperNavigation(): State {
  // Contexts
  ...
  const items: SideNavigationProps.Item[] =
    useMemo((): SideNavigationProps.Item[] => {
      const sideNavigationItems: readonly SideNavigationProps.Item[] =
        mapTranslationFunctionToCloudscapeSideNavigationItems(translate);
