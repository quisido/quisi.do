      ...
      <Main>
        <Region heading={<I18n>Terms of service</I18n>}>
          ...
          <Paragraph>
            ...
            and regulations. You agree not to use this website for any illegal
            or unauthorized purpose. You agree not to use this website to engage
            in any activity that is harmful to others. You agree not to use this
            website to violate any intellectual property rights of others. You
            agree not to use this website to violate any privacy rights of
            others. You agree not to use this website to violate any other law
            or regulation.
          </Paragraph>
          <Paragraph>
