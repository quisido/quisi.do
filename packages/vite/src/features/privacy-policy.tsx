  ...
  return (
    <Section header={<I18n>Privacy policy</I18n>}>
      ...
      <Div element="p" marginBottom="medium">
        ...
        as Cloudflare Insights, Datadog RUM, and Google Analytics. This data is
        aggregated and dashboarded to transparently monitor the website&apos;s
        performance. These services use cookies, and cookie functionality will
        be documented in quisi.do&apos;s{' '}
        <Link
          feature="privacy"
          href="/cookies/"
